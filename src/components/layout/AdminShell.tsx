...
const NAV = [
  ...
  { label: "Reports", to: "/admin/reports" as const, icon: FileText },
    ...
    <div className="min-h-screen bg-background">
      ...
      {open ? (
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          <aside className="absolute inset-y-0 left-0 w-72 border-r border-admin/25 bg-elevated">{sidebar}</aside>
        </div>
      ) : null}
