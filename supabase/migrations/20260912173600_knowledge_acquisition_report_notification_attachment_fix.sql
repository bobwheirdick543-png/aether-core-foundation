...
select '20260912173600',array['fix acquisition report notification trigger for notifications schema without updated_at'],'knowledge_acquisition_report_notification_attachment_fix','bobwheirdick543@gmail.com',null,array[]::text[]
where not exists(select 1 from supabase_migrations.schema_migrations where version='20260912173600');
commit;
