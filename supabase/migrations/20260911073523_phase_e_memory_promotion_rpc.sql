...
BEGIN
  ...
  VALUES (c.owner_id, c.project_id, c.scope, c.memory_type, c.content, 'approved_candidate', c.reason, c.confidence, c.source_conversation_id, c.source_message_id, c.source_task_id) RETURNING id INTO new_memory;
