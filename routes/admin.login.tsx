    ...
    try {
      ...
      if (!result.ok) {
        const messages: Record<string, string> = {
          admin_email_not_configured: "Aether bootstrap administrator email is not configured on the server.",
          ...
          supabase_signin_failed: "Supabase Auth did not accept the administrator credentials. Check the Auth account and try again.",
        };
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="panel mt-8 p-6">
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Sign in with the bootstrap administrator account through Supabase Auth.
          </p>
          ...
          <p className="mt-6 text-xs text-muted-foreground">
            The bootstrap administrator email is server-configured; the password is managed exclusively by Supabase Auth.
          </p>
        </div>
      </div>
    </div>
